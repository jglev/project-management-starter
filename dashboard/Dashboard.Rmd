...
primary_file <- file.path("..", "Project_Notes.md")
secondary_file <- file.path("..", "Project_Notes_Example.md")
...
_Note: _ Only tasks that have `SCHEDULED` and / or `DEADLINE` elements are listed here.
